$(document).ready(function(){
    ...
    var _constructor= function(){
        ...
        $('#download-btn').click(function(){
            ...
            var imagen = _canvas.toDataURL("image/jpg");//Transforma el contenido del canvas en datos.
            this.href = imagen;
            console.log(imagen);
            this.setAttribute("download","canvas.jpg");
            
        });

        /*nueva_Instancia_Unica_Guardar = document.getElementById("download-btn");
        nueva_Instancia_Unica_Guardar.addEventListener("click",descargar,false);
        function descargar(){
            var imagen = _canvas.toDataURL("image/png");//Transforma el contenido del canvas en datos.
            this.href = imagen;
            console.log(imagen);
            nueva_Instancia_Unica_Guardar.setAttribute("download","canvas.png");
        }*/
        /**
